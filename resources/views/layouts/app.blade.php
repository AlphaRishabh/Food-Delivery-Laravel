...
<body style="height:100%;padding:0;margin:0;background-image: url('https://media.istockphoto.com/id/1467579938/photo/abstract-seamless-marble-pattern-artificial-stone-texture-beige-marbling-with-golden-veins.webp?s=2048x2048&w=is&k=20&c=cx5eOYc2wUIoWViZnOZdAEYp3u5UZBFZrMeD6dnzY1I='); background-size:cover;">
    
    <div id="app" class="min-h-screen flex flex-col">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background-color:rgb(239, 242, 239); border-style:groove;border-radius:5px;">

            <div class="container">
            <a class="navbar-brand font-bold text-xl" href="{{ url('/') }}" style="color: red; font-weight: bold; font-size:30px;">
            <h1><i>Yummy Kitchen</i></h1>
            </a>
