...
<!-- <div class="hidden flex w-full justify-center items-center" id="message-modal" data-object="{{ Session::get('unauthorized')}}">
    <div class="px-4 py-2 mb-4 mx-2 bg-red-100 w-8/12 flex">
        ...
        <button type="button" class="close text-lg" id="close">Hello Feined</button>
    </div>
</div> -->

<div>
    <img src="https://i.ibb.co/sj7kHGC/bg.jpg" alt="Background Image" style="height:93vh; width:180vh;border-radius:10px; padding-left:28vh;"  >
    <br><br>
</div>
...
<div class="mx-8">
    <div class="flex flex-row">
        <div class="flex flex-row space-x-4 flex-grow">
            ...
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Pizza" class="sort-font">Pizza</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Burgers" class="sort-font">Burgers</a>
            </div>
            <div class="py-1 px-3 border-solid border-1 border-slate-300 rounded-xl text-center bg-white">
                <a href="../home/Wraps" class="sort-font">Wraps</a>
            </div>
        </div>
...
<div class="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-5">
    ...
    <div class="rounded-md overflow-hidden shadow-md border-1 border-gray-100 bg-light">
        <a href="../food/{{$data['id']}}">
            <img class="h-48 w-full object-cover" src="{{$data['picture']}}" alt="Food Image">
            <div class="p-4">
